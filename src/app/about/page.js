...
export default function About() {
  return (
    ...
    <div className=" animateGradient  bg-gradient-conic from-slate-400 via-grey-800 to-grey-100 shadow-2xl p-8 sm:m-48 mx-4 my-4  rounded-xl md:flex-col   flex md:flex-row gap-4 item-center justify-center mx-auto ">
     <div>
      <h1>About</h1>
      <br/>
